...
describe('Admin', () => {
  ...
  describe('/POST admin register login token check', () => {
      it('register login token check', (done) => {
        chai.request(server)
   ...
   describe('/POST admin login with fake details', () => {
    it('login should be failed', (done) => {
      chai.request(server)
          .post('/PeraRide/v1/login/admin')
          .set('content-type','application/x-www-form-urlencoded')
          .send(admin)
                                    ...
                                    .end((err, res) => {
                                        ...
                                        chai.request(server)
                                            ...
                                            .end((err, res) => {
                                                ...
                                                res.should.have.status(200)
                                                res.body.should.have.property('res').to.be.true
                                                res.body.should.have.property('riders').should.be.a('object')
                                                done()
                                            })
                                    })
                          })
